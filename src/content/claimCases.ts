...
export const CLAIM_CASES: ClaimCase[] = [
  {
    ...
    asOf: "2026-08",
    situation:
      "한 완성차 업체의 지난달 판매가 전년 같은 달보다 14.2% 줄었다는 집계가 나왔어요. 한 리포트는 파업에 따른 생산 중단이 주원인이었을 것으로 봤어요.",
    question: "지금 확인된 사실은?",
    choices: [
    ...
    answerType: "fact",
    why: "판매 증감은 집계에 가깝고, ‘왜 줄었나’는 아직 해석이에요. 둘을 한 문장으로 사실처럼 묶지 않아요.",
    nextToCheck: ["공장 가동일수", "재고", "다음 달 판매"],
  },
  {
    id: "cl-guidance-vs-estimate",
    title: "회사가 모델을 늘리겠다고 했어요. 내년 수익이 좋아질까요?",
    asOf: "2026-09",
    situation:
      "회사가 내년부터 하이브리드 모델을 더 늘리겠다고 밝혔어요. 한 증권사 리포트는 이 변화가 내년 평균판매단가(ASP)를 높이는 데 도움이 될 것으로 예상했어요.",
    question: "지금 확인된 사실은?",
    choices: [
    ...
    why: "모델 확대는 회사가 밝힌 계획이에요. 평균판매단가와 수익성이 실제로 좋아질지는 아직 전망이에요.",
  ...
  },
  {
    ...
    asOf: "2026-09",
    situation:
      "리포트 표지에 매수와 목표주가가 적혀 있고, 본문에는 지난 분기 영업이익 숫자가 나와요.",
    ...
    why: "지난 실적 숫자는 공시로 확인된 사실이에요. 목표주가와 매수는 앞으로의 가정에 기댄 투자 의견이에요.",
