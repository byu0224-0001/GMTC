...
export const CONTEXT_CASES: ContextCase[] = [
  ...
  {
    id: "cx-hike-duration",
    title: "금리가 오를 때 장기채 가격이 더 크게 떨어진 이유",
    era: "금리 인상 구간",
    kind: "interpret",
  ...
  {
    id: "cx-spread",
    title: "회사채 금리만 더 크게 올랐을 때",
    era: "신용 경계",
    kind: "interpret",
    situation: "국채 금리는 큰 변화가 없는데, 회사채 금리는 더 빠르게 올랐습니다.",
    question: "기업 조달 비용이 실제로 비싸졌는지 보려면 무엇을 봐야 할까요?",
    answerTermId: "신용스프레드",
    choiceIds: ["신용스프레드", "평가절상", "자기자본이익률-roe", "테이퍼링"],
    why: "국채 금리만 보면 놓칩니다. 국채와 회사채의 차이가 벌어져야 신용위험에 대해 요구되는 추가 금리가 커진 것입니다.",
  ...
  },
  {
    ...
    why: "주택담보대출의 현금흐름과 신용위험이 증권 형태로 이전되며, 연체가 늘면 증권 가격과 자금 조달 여건이 함께 악화될 수 있습니다.",
  ...
  },
  {
    ...
    why: "금리를 올리는 것과는 다른 일입니다. 중앙은행의 자산매입 규모가 축소되면 장기금리가 먼저 움직일 수 있습니다.",
    chain: ["양적완화", "테이퍼링", "장기금리", "유동성"],
  },
  {
    id: "cx-current-account",
    title: "경상수지 흑자가 환율에 미치는 영향",
    era: "대외 거래",
  ...
  },
  {
    ...
    why: "이 비율을 낮추면 대출 가능 금액이 줄어 주택 구매 여력을 제약할 수 있습니다.",
    chain: ["집값", "LTV", "가계대출", "금리"],
  },
  {
    id: "cx-dsr",
    title: "금리 상승으로 대출 한도가 줄어드는 이유",
    era: "가계부채",
    ...
    why: "금리가 오르면 원리금이 커져 같은 소득으로도 대출 가능 한도가 줄어 차입 여력을 제약할 수 있습니다.",
  ...
  {
    id: "cx-liquidity",
    title: "원하는 가격에 거래하기 어려워졌을 때",
    era: "시장 경색",
    situation: "채권 호가는 떠 있지만 실제 체결이 거의 없고, 조금만 팔아도 가격 변동이 커집니다.",
    question: "이 상황에서 먼저 무너진 것은?",
    answerTermId: "유동성",
    choiceIds: ["유동성", "인플레이션", "기회비용", "블록체인"],
    why: "흔들릴 때는 값이 얼마냐보다, 원하는 시점에 큰 가격 충격 없이 거래할 수 있는지가 먼저 사라집니다.",
  ...
  {
    id: "cx-stagflation",
    title: "경기 둔화와 물가 상승이 함께 나타날 때",
    era: "스태그플레이션 논쟁",
    situation: "에너지 가격 충격으로 소비자물가는 높게 유지되는데, 성장률과 고용은 동시에 약해졌습니다.",
    question: "이 상황을 가리키는 용어는 무엇일까요?",
    answerTermId: "스태그플레이션",
    choiceIds: ["스태그플레이션", "골디락스경제", "양적완화정책", "공매도"],
    why: "성장과 물가가 같은 방향으로 움직이지 않으면, 금리만으로 둘을 한 번에 해결하기 어렵습니다.",
    chain: ["공급 충격", "인플레이션", "성장 둔화", "스태그플레이션"],
  },
  {
    id: "cx-carry",
    title: "금리가 낮은 통화로 자금을 빌려 투자할 때",
    era: "환율·금리 차",
  ...
  },
  {
    ...
    why: "옵션 가격에서 산출한 향후 변동성 기대 지수입니다. 주가가 오를지 내릴지를 알려 주지는 않습니다.",
    chain: ["옵션", "변동성", "VIX", "위험 회피"],
  },
  {
    id: "cx-unemployment",
    title: "고용이 약해지면 금리 기대는 어떻게 달라질까",
    era: "고용과 통화정책",
    situation: "실업률이 예상보다 빠르게 오르자, 시장은 중앙은행이 인상을 멈출 가능성을 더 높게 보기 시작했습니다.",
    question: "고용 여건을 나타내는 이 지표는?",
    answerTermId: "실업률",
  ...
  {
    id: "cx-fx-reserve",
    title: "환율 급변 시 활용할 수 있는 외화 자산",
    era: "환율 급등",
    situation: "원화가 빠르게 약해지자, 당국이 갖고 있던 외화로 달러 유동성을 공급했다는 해석이 나왔습니다.",
    question: "이런 대응에 쓰일 수 있는 외화 자산 규모는 무엇일까요?",
    answerTermId: "외환보유액",
  ...
  },
  {
    ...
    why: "뉴스의 금리는 대개 명목입니다. 구매력 기준의 실질 수익을 보려면 물가를 함께 고려해야 합니다.",
    chain: ["명목금리", "인플레이션", "실질금리", "소비"],
  },
  {
    id: "cx-lender-last",
    title: "금융시장의 유동성이 부족할 때 중앙은행의 역할",
    era: "위기 대응",
    ...
    why: "부실 기관을 무조건 살려 주는 역할이라기보다, 일시적으로 현금이 부족한 시장에 자금을 공급하는 역할에 가깝습니다.",
  ...
  },
  {
    ...
    why: "국고채 금리가 오르면 이미 들고 있던 채권의 평가 가격은 내립니다. 증권사 실적 이야기에서 자주 나옵니다.",
  ...
  },
  {
    ...
    why: "생산능력이 한도에 닿았다고 끝이 아닙니다. 납기(리드타임)가 늘어나면 선주문과 다른 업체로의 주문 이동이 시작될 수 있습니다.",
    chain: ["수요", "CAPA", "리드타임", "주문 이동"],
    nextToCheck: ["리드타임", "선주문", "생산 여력이 있는 업체"],
    freshness: "evergreen",
  },
  {
    id: "cx-product-mix",
    title: "판매량이 비슷해도 이익이 줄 수 있는 이유",
    era: "실적 분해",
    kind: "interpret",
    situation: "전체 판매 대수는 크게 안 줄었는데, 수익성이 높은 차종의 비중이 줄었다는 코멘트가 나왔습니다. 리포트는 매출보다 마진을 걱정했습니다.",
    question: "판매량이 비슷한데도 이익이 줄 수 있다면, 무엇을 먼저 의심해야 할까요?",
